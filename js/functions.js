...
document.addEventListener("DOMContentLoaded", function(event) {
    document.getElementById("triger_modal").addEventListener("click", () => {

        // document.querySelector(".frame-video iframe").src= "video/camichalo_lite.mp4?autoplay=1"
        document.querySelector(".frame-video iframe").src= "https://www.youtube.com/embed/Qgr9pOSgLQo"


        document.querySelector(".modal").classList.add("modal-show");
        
        document.querySelector(".close-frame").addEventListener("click",() => {
            document.querySelector(".modal").classList.remove("modal-show");
            // document.querySelector(".modal").classList.add("modal-hide");
            document.querySelector(".frame-video iframe").src= ""
        })
    })
    ...
    document.getElementById("submit_btn1").addEventListener("click", () => {
        ...
        if (templateParams.name != '' && templateParams.email != '' && templateParams.message != '' )
        {
            ...
            emailjs.send('service_20q7g5i', 'template_wlfordg', templateParams) //use your Service ID and Template ID
...
jQuery($=> {
    ...
    $("#submit_btn1 , #submit_btn").on('click', function () {
        ...
        if (proceed) {
            ...
            output = '<div class="alert-danger" style="padding:10px; margin-bottom:25px;">Favor de llenar todos los campos.</div>';
            result.slideUp("fast").html(output).slideDown();
        }
